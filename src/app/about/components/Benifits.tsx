...
export default function Benefits(){
    return(
        <section className="w-full h-[481px] py-[52px] px-[93px]" style={{ backgroundImage: "url('/images/Image (2).png')", backgroundSize: "cover" }}>
            <div className="w-full h-[364px] bg-transparent flex flex-col justify-center items-center gap-20">
                <div className="w-[571px] h-[114px] flex flex-col items-center justify-center gap-[16px]">
                    <h1 className="text-[36px] text-white leading-[140%] font-poppins">Join the club and get the benefits</h1>
                    <div className="w-[470px] h-[48px]">
                        <p className="text-center font-poppins text-white text-[16px] leading-[150%]">Sign up for our newsletter and receive exclusive offers on new ranges, sales, pop up stores and more</p>
                    </div>
                </div>
